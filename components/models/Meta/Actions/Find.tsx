...
export const Find = ({ data, setData }: any) => {
    ...
    return (
        <div className="border rounded-lg p-6">
            ...
            <div className="space-y-4">
                {['canFindMany', 'isAuth', "canFindOne", "canFindOnUpdate", "canFindOnList"].map((field) => (
                    <div key={field} className="flex items-center justify-between">
                        <Label>{field}</Label>
                        <Switch
                            checked={data?.fieldFind?.create?.[field]}
